...
set runtimepath&
set runtimepath+=~/projects/vim-ref,~/projects/vim-quickrun,~/projects/vim-autocomplpop,~/projects/vim-fuzzyfinder,~/projects/snipmate.vim,~/projects/snipmate.vim/after,~/projects/conf/vim/runtime,~/projects/conf/vim/runtime/after
